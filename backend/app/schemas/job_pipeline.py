...
from app.models.job_pipeline import PIPELINE_STAGES
...
class InterviewInfo(BaseModel):
    ...
    interview_at: str | None = Field(default=None, description="面试时间，ISO 格式")
...
class OfferInfo(BaseModel):
    ...
    offer_deadline: str | None = Field(default=None, description="Offer 回复截止日期，ISO 格式")


class PipelineBase(BaseModel):
    resume_id: int | None = Field(default=None, description="关联简历 ID")
    resume_version_id: int | None = Field(default=None, description="投递使用的简历版本 ID")
    feedback_type: str = Field(default="", max_length=30)
    feedback_score: int | None = Field(default=None, ge=1, le=5)
    feedback_tags: list[str] = Field(default_factory=list)
    feedback_note: str = Field(default="")
    jd_id: int | None = Field(default=None, description="关联 JD ID")
    ...
    follow_up_at: str | None = Field(default=None, description="下次跟进时间，ISO 日期/时间字符串")
    ...
    # 面试信息
    interview_at: str | None = Field(default=None, description="面试时间")
    ...
    offer_salary: str = Field(default="", max_length=100, description="Offer 薪资")
    offer_details: dict[str, Any] = Field(default_factory=dict, description="Offer 详情")
    offer_deadline: str | None = Field(default=None, description="Offer 回复截止日期")
...
class PipelineUpdateReq(BaseModel):
    ...
    experience_requirement: str | None = Field(default=None, max_length=50)
    ...
    priority_label: str | None = Field(default=None, max_length=50)
    stage: str | None = None
    note: str | None = None
    next_action: str | None = Field(default=None, max_length=255)
    follow_up_at: str | None = None
    resume_name: str | None = Field(default=None, max_length=255)
    stage_history: list[StageHistoryItem] | None = None
    # 面试信息
    interview_at: str | None = None
    interview_type: str | None = None
    interview_round: int | None = Field(default=None, ge=0)
    interview_location: str | None = None
    interview_contact: str | None = None
    # Offer 信息
    offer_salary: str | None = Field(default=None, max_length=100)
...
class StageTransitionReq(BaseModel):
    ...
    interview_at: str | None = Field(default=None, description="面试时间")
    interview_type: str | None = Field(default=None, description="面试类型")
    interview_round: int | None = Field(default=None, ge=0)
    interview_location: str | None = Field(default=None, description="面试地点/视频链接")
    interview_contact: str | None = Field(default=None, description="面试联系人")
    # Offer 信息（流转到 offer 时可携带）
    offer_salary: str | None = Field(default=None, max_length=100)
    offer_details: dict[str, Any] | None = None
    offer_deadline: str | None = Field(default=None)
...
class PipelineKanbanResp(BaseModel):
    ...
    stages: dict[str, list[dict[str, Any]]] = Field(..., description="按阶段分组的投递记录")
    stage_counts: dict[str, int] = Field(..., description="各阶段记录数")
