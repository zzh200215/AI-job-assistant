...
from sqlalchemy import BigInteger, Column, DateTime, String, Integer, Text, JSON
...
class AuditLog(Base):
    ...
    action = Column(String(100), nullable=False, index=True, comment="操作类型: subscription.payment / user.delete / data.export / resume.delete 等")
